...
const PrivacyPolicyPage = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar />
      <main className="flex-grow max-w-4xl mx-auto p-4 md:p-8 mb-8">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Simak Builders,
                Nediyiruppu, Kondotty.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Simak Builders, accessible
                from{" "}
                <a
                  href="https://www.simakbuilders.com"
        ...
        <div className="mt-8">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              <p>
                <strong>For the performance of治</strong> the development,
            ...
            <li>
              <p>
                ...
                for other purposes, Редактироватьsuch as data analysis,
          ...
          <ul className="list-disc pl-5">
            <li>
              <p>
                By email:{" "}
                <a
                  href="mailto:admin@simakbuilders.com"
                  className="text-blue-600 hover:underline"
                >
                  admin@simakbuilders.com
                </a>
              </p>
            </li>
            {/* <li>
              <p>
                ...
                <a
                  href="https://simakbuilders.com/policy"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="text-blue-600 hover:underline"
                >
                  https://simakbuilders.com/policy
                </a>
              </p>
            </li> */}
          </ul>
